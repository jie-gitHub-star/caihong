...
<!--重复内容-->
            <div class="sitemain1">
                <div class="title">
                    <i class="Pu iconfont icon-shouqi">
                    </i>
                    <a title><!-- <?= $typeList_tmp[1]['name'] ?> --></a></div>
                <ul class="list3">
                    <?php if(isset($goodsList)): foreach ($goodsList as $key => $value): ?>
                    <li>
                    <a href="<?= url('detail',['gid'=>$value['id']]); ?>">
                        <img src="<?= __PUBLIC ?>/uploads/good/<?= $value['pic'] ?>">
                        <p><?= $value['name'] ?></p>
                    </a>
                    </li>
                    <?PHP endforeach; endif; ?> 
                    <?php if(! @$goodsList_search==null): foreach ($goodsList_search as $key => $value): ?>
                    <li>
                    <a href="<?= url('detail',['gid'=>$value['id']]); ?>">
                        <img src="<?= __PUBLIC ?>/uploads/good/<?= $value['pic'] ?>">
                        <p><?= $value['name'] ?></p>
...
<!--                 <div class="title">
                    ...
                    <a title>手机 电话卡</a></div>
                <ul class="list3">
                    <li>
                    <a href="">
                        <img src="img/shoplist/m8-140.png">
                        <p>小米8</p>
                    </a>
                    </li>
                    <li>
