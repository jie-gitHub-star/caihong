        ...
        <!--    右边部分 -->
            <div class="main-right">
                ...
                <tr>
                    ...
                    <td colspan="4" style="background:#999;border-bottom:1px solid #666" class="F-16"><?= $value['addtime'] ?> 订单号：<font size="1"><?= $value['oid'] ?></font></td>
                </tr>
                <tr height="100">
                    <td><?= $value['username'] ?></td>
                    <td><div>价格</div>共<?= $value['total'] ?>元</td>
                    <td><font size='2'><?= $status[$value['status']] ?></font><br>
                        <font size='2' color="green"><?= $is_pay[$value['is_pay']] ?></font></td>
                    <td><font size='2'><a href="<?= url('edit',['id'=>$value['id']]) ?>"><font color="red">确定收货</font></a> | <a href="<?= url('order_detail',['oid'=>$value['oid']]) ?>">详情</a></font></td>
